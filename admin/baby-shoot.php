            ...
            <div class="card">            	
                <div class="card-header">                		
                    <div class="row align-items-center">                    		
                        ...
                        <div class="col-auto"> 											
                            <a href="add-baby.php" class="btn btn-primary" >			
                ...
                <div class="card-body pt-0">                                                    		
                    <div class="table-responsive">                    		
                        <table class="table mb-0 checkbox-all" id="datatable_1">                        			
                            ...
                            <tbody> 								 
                                <?php                                
                                $bsql=mysqli_query($connect,"SELECT * FROM `baby_shoot`");                                
                                ...
                                <tr>                                				
                                    ...
                                    <td class="ps-0"> 						                                        
                                        <img src="uploads/baby/<?php echo $brow['bs_img'];?>" alt="" height="70">										                                           				                                  																									
                                        <p class="d-inline-block align-middle mb-0">					
                                            <a href="#" class="d-inline-block align-middle mb-0 product-name">												
                                                <?php echo $brow['bs_img']; ?>
                                            </a>					
                                            <br>                                                           					
