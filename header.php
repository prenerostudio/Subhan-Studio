...
<html lang="zxx">
    <head>		
        ...
        <meta property="og:url" content="https://subhanstudio.com" />	
                                ...
                                <div class="atf-top-header-in">				
                                    <ul class="atf-top-header-list">				
                                        <li>
											...
											<a href="#">subhansstudio@gmail.com</a>
										</li>					
                                        <li>
											<i class="fas fa-phone-volume"></i>
											<a href="#">+92 302 750 9932 </a>
										</li>					
                                        <li>
											<i class="fas fa-map-marker-alt"></i>
											<a href="#">Faisalabad, Pakkistan .</a>
										</li>  					
                                    </ul>				
                                </div>				
                            </div>			
                            <div class="col-lg-3 col-md-4">			
                                <div class="atf-top-social">				
                                    <div class="atf-top-social-icon">				
                                        <a href="https://www.facebook.com/subhansstudio/" target="_blank" class="icon"> 
											<i class="fab fa-facebook"></i> 
										</a>					
                                        <a href="https://www.instagram.com/subhan_studio888/" target="_blank" class="icon"> 
											<i class="fab fa-instagram"></i> 
										</a>					
                                        <a href="https://www.youtube.com/channel/UC9ECxGub-REPu4JgBqDdajA" target="_blank" class="icon"> 
