...
Subhan Photo Studio is a best photography in faisalabad  studio known for its expertise in capturing memorable moments and creating striking images, offering a range of photography services for various occasions and subjects.</p>
							...
							<div class="col-lg-2 col-md-6 col-6 atf-footer-link">
								...
								<ul class="atf-list-menu">
									...
									<li><a href="#"><i class="fas fa-chevron-right me-2"></i>Terms of Services</a></li>
									<li><a href="#"><i class="fas fa-chevron-right me-2"></i>FAQ's</a></li>
									<li><a href="our-team.php"><i class="fas fa-chevron-right me-2"></i>Our Team</a></li>
									<li><a href="contact.php"><i class="fas fa-chevron-right me-2"></i>Contact Us</a></li>
								</ul>
							</div><!--- END COL -->
