					...
					<div class="row clearfix">
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="atf-single-team wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
								<div class="atf-team-pic">
									<img src="img/team/mirza-yasir.jpeg" alt="">
								</div>
								<div class="atf-team-content">
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="atf-single-team wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" data-wow-offset="0">
								<div class="atf-team-pic">
									<img src="img/team/Khurram-Ejaz.jpg" alt="">
								</div>
								<div class="atf-team-content">
					...
					<div class="row clearfix" style="padding-top: 80px;">
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="atf-single-team wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
								...
								<div class="atf-team-content">
									<h3 class="atf-team-title"><a href="#">Asad Ali</a></h3>
									<span class="atf-team-post">Photographer</span>
								</div>
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="atf-single-team wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" data-wow-offset="0">
								<div class="atf-team-pic">
									<img src="img/team/mehwish-choudhry.jpg" alt="">
								</div>
								<div class="atf-team-content">
									<h3 class="atf-team-title"><a href="#">Mehwish CH</a></h3>
									<span class="atf-team-post">Photographer</span>
								</div>
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="atf-single-team wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s" data-wow-offset="0">
								<div class="atf-team-pic">
									<img src="img/team/haroon.jpg" alt="">
								</div>
								<div class="atf-team-content">
