...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="images/logo.svg" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="profile.html"><img src="images/profile_av.jpg" alt="User"></a>
                    <div class="detail">
                        <h4>Michael</h4>
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>Gallery Section</span></a>
                <ul class="ml-menu">
                    <li><a href="wedding-shoot.php">Wedding Shoot</a></li>
                    <li><a href="#">Baby Shoot</a></li>
                    <li><a href="#">Model Shoot</a></li>
                    <li><a href="#">Product Shoot</a></li>

                    <li><a href="#">Corporate Shoot</a></li>                    
                </ul>
            </li>
