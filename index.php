        ...
        <div class="row justify-content-center">	
            <div class="col-lg-12 col-md-12 col-12">	
                <div class="atf-section-title text-center wow zoomIn" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">		
                    <h5 class="atf-sheading">Best Photographer in Faisalabad.</h5>		
                ...
                <div id="atf-home-active" class="atf-main-testimonials atf-testimonial-slider owl-carousel owl-theme">
                    <div class="atf-best-service-slide">		
                        <div class="atf-best-service-img">			
                            <a href="img/services/event-photo.jpg" data-rel="lightcase:myCollection">			
                                <img src="img/services/event-photo.jpg" alt="Blog">
							</a> 				
                        </div>			
                    ...
                    <div class="atf-best-service-slide">		
                        <div class="atf-best-service-img">			
                            <a href="img/services/stage.jpg" data-rel="lightcase:myCollection">			
                                <img src="img/services/stage.jpg" alt="Blog">
							</a> 				
                        </div>			
                        <div class="atf-best-service-content text-center">			
                    ...
                    <div class="atf-best-service-slide">		
                        ...
                        <div class="atf-best-service-content text-center">			
                            ...
                            <p class="atf-best-service-description">We deal all king of Videography with base Kit and SMD (Surface Mount Device).</p>
                        </div>			
                    </div>		                    		
                </div>		
            </div>	
            ...
            <div class="row clearfix">	
                <div class="col-md-12 col-lg-12">		
                    <div class="atf-brand-active owl-carousel">		
                        <a href="#">
							<img src="img/partner/Grand City.jpg" alt="image">
						</a>			
                        <a href="#">
							<img src="img/partner/Peramount.png" alt="image">
						</a>			
                        <a href="#">
							<img src="img/partner/Skin care.jpg" alt="image">
						</a>			
                        <a href="#">
							<img src="img/partner/spirit-school-logo.png" alt="image">
						</a>			
                        <a href="#">
							<img src="img/partner/superior colleges.png" alt="image">
						</a>			
                        <a href="#">
							<img src="img/partner/Superior.png" alt="image">
						</a>			
                        <a href="#">
							<img src="img/partner/misaq-residencia.png" alt="image">
						</a>			
                        <a href="#">
							<img src="img/partner/tms.png" alt="image">
						</a>		
                    </div>		
                </div>		
            </div>	
    ...
    <div class="container">
        <div class="row atf-hire-area">	
            ...
            <div class="col-xl-4 col-12 atf-hire-btn text-end mt-lg-40 mt-3">	
                <a href="contact.php" class="atf-themes-btn" data-hover="Get Start Now">
        ...
        <div class="row">	
            <div class="col-lg-4 col-md-6 col-12">	
                <div class="pricingTable">		
                    ...
                    <ul class="pricing-content">		
						...
						<li>1 Wedding Videographer</li>
                        <li>Bride & Groom Photoshoot</li>			
                        <li>10 Page Story Book</li>			
            ...
            <div class="col-lg-4 col-md-6 col-12">	
                <div class="pricingTable">		
                    ...
                    <ul class="pricing-content">		
                        <li>Senior Wedding photographer</li>
                        <li>Bride & Groom Photoshoot</li>			
                        <li>12 Page 2 Story Book</li>			
                        <li class="">Full Event Video Double Camera</li>			
                        <li class="">Drone Coverage</li>			                        			
